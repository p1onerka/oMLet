...
riscv64-linux-gnu-gcc "$GC" -c -o gc.o
riscv64-linux-gnu-gcc "$BOX" -c -o box.o
riscv64-linux-gnu-gcc "$CALLF" -c -o callf.o
riscv64-linux-gnu-gcc temp.o runtime.o gc.o box.o callf.o -nostartfiles -o binary.exe
qemu-riscv64 -L /usr/riscv64-linux-gnu binary.exe

EXIT_CODE=$?

rm -f temp.o runtime.o gc.o box.o callf.o factorial.exe
