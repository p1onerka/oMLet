...
Всё, что выше с кодогеном через LLVM. Если окажется, что для GC придется сделать что-то зверзки сложное, то я его отменю, а пока предполагается, что GC сломаться не долджен.
